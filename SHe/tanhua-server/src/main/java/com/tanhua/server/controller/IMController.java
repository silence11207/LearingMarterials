...
public class IMController {
     ...
     */
    @GetMapping("contacts")
    public ResponseEntity<PageResult> queryContactList(@RequestParam(value = "page", defaultValue = "1") Integer page,
    ...
    public ResponseEntity<PageResult> queryAnnouncementList(@RequestParam(value = "page", defaultValue = "1")Integer page,
                                            @RequestParam(value = "pagesize", defaultValue = "10") Integer pageSize){
